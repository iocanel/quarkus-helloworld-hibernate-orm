@REM ----------------------------------------------------------------------------
@REM Apache Maven Wrapper startup batch script, version 3.6.0
@REM
...
set WRAPPER_URL="https://repo.maven.apache.org/maven2/io/quarkus/quarkus-cli/3.6.0/quarkus-cli-3.6.0-runner.jar"
...
) else if exist "%USERPROFILE%\.m2\repository\io\quarkus\quarkus-cli{quarkus.version}\quarkus-cli-3.6.0-runner.jar" (
  copy "%USERPROFILE%\.m2\repository\io\quarkus\quarkus-cli{quarkus.version}\quarkus-cli-3.6.0-runner.jar" %WRAPPER_JAR%
) else (
    if not "%QUARKUSW_REPOURL%" == "" (
        SET WRAPPER_URL="%QUARKUSW_REPOURL%/io/quarkus/quarkus-cli/3.6.0/quarkus-cli-3.6.0-runner.jar"
    )
    if "%QUARKUSW_VERBOSE%" == "true" (
